...
<div class="main-article-container">
  <div class="article-content">
    <div class="article-image-wrapper">
      <img src="Asset/Artikel Dalam.jpg" alt="Tips Kehamilan Sehat: Panduan untuk Ibu dan Janin" />
    ...
    <div class="article-body">
      ...
      <div class="summary">
        <p>Pemeriksaan rutin sangat penting untuk mendeteksi dini penyakit dalam seperti diabetes, hipertensi, dan gangguan ginjal. Dengan deteksi dini, pengobatan dapat dilakukan lebih efektif dan risiko komplikasi dapat diminimalkan.</p>
        <p>Banyak penyakit dalam yang pada awalnya tidak menunjukkan gejala, sehingga pemeriksaan berkala menjadi kunci untuk mengetahui kondisi kesehatan tubuh secara menyeluruh. Pemeriksaan meliputi cek tekanan darah, gula darah, fungsi ginjal, dan organ vital lainnya.</p>
        <p>Faktor risiko seperti riwayat keluarga, obesitas, dan gaya hidup kurang sehat dapat meningkatkan kemungkinan seseorang terkena penyakit dalam. Oleh karena itu, penting untuk melakukan deteksi dini dan konsultasi rutin dengan dokter spesialis penyakit dalam.</p>
        <p>Selain pemeriksaan medis, perubahan gaya hidup seperti pola makan sehat, olahraga teratur, dan manajemen stres juga sangat berperan dalam mencegah penyakit dalam. Edukasi kesehatan secara berkelanjutan sangat diperlukan agar masyarakat lebih peduli terhadap kesehatannya.</p>
        <p>Dengan pemeriksaan rutin dan gaya hidup sehat, kualitas hidup dapat meningkat dan risiko penyakit kronis dapat ditekan. Jangan ragu untuk berkonsultasi dengan dokter jika mengalami keluhan atau memiliki faktor risiko tertentu.</p>
      </div>
    </div>
  </div>
</div>

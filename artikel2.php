...
<div style="width:100%; background:##f47b20; min-height:220px; display:flex; align-items:center; justify-content:center; position:relative; margin-bottom:36px; border-radius:28px; overflow:hidden;">
  ...
  <div style="position:relative; z-index:2; text-align:center; width:100%; color:#fff;">
    ...
    <h1 style="font-size:2.7rem; font-weight:700; margin:0; letter-spacing:1px;">Kesehatan Gigi</h1>
    <div style="margin-top:10px;">
    </div>
  </div>
  <img src="Asset/Artikel Gigi.jpg" alt="Header Artikel" style="width:100%; height:100%; object-fit:cover; position:absolute; left:0; top:0; z-index:0; opacity:0.45;" />
</div>
<div class="main-article-container">
  <div class="article-content">
    <div class="article-image-wrapper">
      <img src="Asset/Artikel Gigi.jpg" alt="Menjaga Kesehatan Gigi Sejak Dini untuk Mencegah Karies" />
    ...
    <div class="article-body">
      ...
      <div class="summary">
        <p>Kesehatan gigi dan mulut adalah bagian penting dari kesehatan umum. Sayangnya, karies gigi (gigi berlubang) masih menjadi masalah utama di Indonesia, terutama pada anak-anak usia sekolah. Karies sering kali tidak menimbulkan gejala awal, namun jika dibiarkan, dapat menyebabkan nyeri, infeksi, hingga kehilangan gigi.</p>
        <p>Pencegahan karies dapat dilakukan dengan membiasakan anak menyikat gigi dua kali sehari dengan pasta gigi berfluoride, mengurangi konsumsi makanan manis, dan rutin memeriksakan gigi ke dokter gigi. Edukasi sejak dini sangat penting agar anak terbiasa menjaga kesehatan gigi dan mulut.</p>
        <p>Selain itu, peran orang tua sangat penting dalam membimbing anak untuk menjaga kebersihan gigi. Orang tua dapat memberikan contoh dengan menjaga kebersihan gigi mereka sendiri dan mengawasi anak saat menyikat gigi.</p>
        <p>Pemeriksaan rutin ke dokter gigi minimal enam bulan sekali dapat membantu mendeteksi masalah gigi sejak dini. Dokter gigi juga dapat memberikan saran dan tindakan pencegahan tambahan sesuai kebutuhan anak.</p>
        <p>Dengan menjaga kesehatan gigi sejak dini, anak-anak dapat terhindar dari berbagai masalah gigi di masa depan dan tumbuh dengan percaya diri. Mari biasakan pola hidup sehat untuk gigi dan mulut yang sehat.</p>
      </div>
    </div>
  </div>
  <aside class="sidebar-artikel">
    <div class="sidebar-box">
      ...
      <ul style="list-style:none; padding:0; margin:0;">
        ...
        <li style="margin-bottom:10px;">
          <a href="artikel.php?kategori=Gigi" style="display:block; padding:7px 0 7px 0; color:#009688; text-decoration:none; font-size:1.13rem; font-weight:700; transition:color 0.2s;">Gigi</a>
        </li>
        <li style="margin-bottom:10px;">
